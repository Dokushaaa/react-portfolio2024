...
const ContactsHome = () => {
	...
	const [pageHandler, setPageHanlder] = React.useState("Contacts");
	const {
		isLoading,
		isFetching,
		error,
	...
	return (
		<section className='flex overflow-x-hidden'>
				...
				<div className='flex relative'>
					<div className={`main-wrapper transition-all px-4 py-3 w-full`}>
						<div className='flex justify-between items-center'>
							<h1 className='leading-none mb-0'>Contacts Database</h1>
						</div>
			...
			{store.isAdd && <ModalAddContacts itemEdit={itemEdit} />}
			{store.success && <Toast />}
