...
const AboutTable = ({ isLoading, about, isFetching, setItemEdit }) => {
	let counter = 1;
						...
						<tbody>
							...
							{about?.data.map((item, key) => (
								<tr key={key}>
									...
									<td>{item.about_is_active}</td>
									<td>{item.about_published_date}</td>
									<td>{item.about_created}</td>
									<td>{item.about_datetime}</td>
